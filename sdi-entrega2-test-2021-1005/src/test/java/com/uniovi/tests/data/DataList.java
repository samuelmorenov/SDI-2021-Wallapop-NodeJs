...
public class DataList {
	...
	public static final int maxOffer = 6;
	...
	public final static UserDto usuarios(int iterator) {
		...
		list[1] = new UserDto("lucas@email.com", "Lucas", "Núñez", "123456", roles[0]);
		list[2] = new UserDto("maria@email.com", "María", "Rodríguez", "123456", roles[0]);
